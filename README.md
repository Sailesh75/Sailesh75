...
| [**MacroLens**](https://github.com/Sailesh75/macro-lens) — [live app](https://frontend-sigma-liart-68.vercel.app) · [API docs](https://ai-macro-logger-prod.onrender.com/docs) | AI meal-logging app: identifies food from a photo or text description, matches it to real USDA nutrition data, and learns your typical portion sizes over time. | Python, TypeScript, FastAPI, LangGraph, Gemini |
